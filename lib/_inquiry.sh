...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu ChatbotSolutions que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao ChatbotSolutions selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar ChatbotSolutions\n"
  printf "   [1] Atualizar ChatbotSolutions\n"
  printf "   [2] Deletar ChatbotSolutions\n"
  printf "   [3] Bloquear AChatbotSolutions\n"
  printf "   [4] Desbloquear AChatbotSolutions\n"
  printf "   [5] Alter. dominio AChatbotSolutions\n"
  printf "\n"
  read -p "> " option
